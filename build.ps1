...
try {
    flet build windows `
        ...
        --exclude ".git, build.ps1, release, icons, Sola-cache, README.md, certs, test, .gitignore, .vscode, .venv, Sola.aip, sola-updater.aip, updates.txt, requirements.txt, README.md, poetry.lock" `
